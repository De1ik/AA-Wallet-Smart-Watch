            ...
            <View style={styles.detailsContainer}>
              <View style={styles.detailRow}>
                ...
                <View
                  style={[
                    styles.keyTypeBadge,
                    device.keyType === PermissionPolicyType.SUDO ? styles.sudoBadge : styles.restrictedBadge,
                  ]}
                >
                  <Text
                    style={[
                      styles.keyTypeText,
                      device.keyType === PermissionPolicyType.SUDO ? styles.sudoText : styles.restrictedText,
                    ]}
                  >
                    {device.keyType === PermissionPolicyType.SUDO ? 'Sudo Access' : 'Restricted Access'}
                  </Text>
                </View>
              </View>
