import { wsClient, InstallationStatus } from '@/services/api/websocketClient';
import { DelegatedKeyData, updateDelegatedKey } from '@/modules/delegated-keys/services/delegatedKeys';
